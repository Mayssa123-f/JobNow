      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-4">
          ...
          <div className="hidden md:block">
            <button className="bg-[#fbfbfb] border border-[#00cc99] text-[#00cc99] px-6 py-2 rounded-md hover:bg-[#00cc99] hover:text-white font-bold transition-all">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="md:col-span-3 md:w-[60%] flex flex-col gap-4 text-center md:text-left items-center md:items-start w-full">
